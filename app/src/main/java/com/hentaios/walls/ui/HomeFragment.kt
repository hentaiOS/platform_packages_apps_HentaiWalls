...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModel by sharedViewModel<WallViewModel>()
        ...
        val list = listOf(
            WallCollection(
                "Ahegao",
                listOf(Wallpaper("https://i.ibb.co/b25VFdB/wall.png", "Raphielscape"))
            ),
            WallCollection(
                "NTR",
                listOf(Wallpaper("https://i.imgur.com/GL7igry.png", "Raphielscape"))
            ),
            WallCollection(
                "Living in hentai",
                listOf(Wallpaper("https://i.imgur.com/XULiMJ5.jpg", "Raphielscape"))
            ),
            WallCollection(
                "Lewds",
                listOf(Wallpaper("https://i.imgur.com/ZBk3W8l.jpg", "Raphielscape"))
            ),
            WallCollection(
                "Waifus",
                listOf(Wallpaper("https://i.imgur.com/kZPEccB.jpg", "Raphielscape"))
            ),
            WallCollection(
                "Mind Break",
                listOf(Wallpaper("https://i.imgur.com/O5mO0wh.jpg", "Raphielscape"))
            )
        )
